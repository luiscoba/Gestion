...
public class ReferenciaApiResponse implements Parcelable {
    ...
    public ReferenciaApiResponse() {
    }

    protected ReferenciaApiResponse(Parcel in) {
    ...
    public static final Creator<ReferenciaApiResponse> CREATOR = new Creator<ReferenciaApiResponse>() {
        @Override
        public ReferenciaApiResponse createFromParcel(Parcel source) {
            return new ReferenciaApiResponse(source);
        }

        @Override
        public ReferenciaApiResponse[] newArray(int size) {
            return new ReferenciaApiResponse[size];
        }
    };
}
